...
import static com.example.plantdiseases.R.*;
...
//        textWelcome.setText(category);
    ...
    private void loadCategoryContent() {
        ...
        if (category.equals("Fungal")) {
            ...
            Button buttonFungal = new Button(this);
            buttonFungal.setText("Late Blight");
            Button button1Fungal = new Button(this);
            button1Fungal.setText("Late Blight2");
            Button button2Fungal = new Button(this);
            button2Fungal.setText("Late Blight3");
            Button[] arrayButtonFungal = {buttonFungal, button1Fungal, button2Fungal};
            for(int btn = 0;btn <arrayButtonFungal.length;btn++) {
                Button buttons = arrayButtonFungal[btn];
                buttonLinear.addView(buttons,buttonLinear.getLayoutParams());
                buttons.setBackgroundResource(R.drawable.rounded);
                buttons.setTypeface(null, Typeface.BOLD);
                ((ViewGroup.MarginLayoutParams) buttons.getLayoutParams()).setMargins(20, 20, 20, 20);

            }
            button1Fungal.setOnClickListener(view -> {
                if (currentLanguage.equals("en")) {
                    htmlText = "hello";
                }
                else{
            ...
            button2Fungal.setOnClickListener(view -> {
                if (currentLanguage.equals("en")) {
                    htmlText = "hello";
                }
                else{
            ...
            buttonFungal.setOnClickListener(view -> {
                    if (currentLanguage.equals("en")) {
        ...
        if (category.equals("Bacterial")) {
            Button buttonBac = new Button(this);
            buttonBac.setText("Bacterial Canker of Tomato");
            Button button1Bac = new Button(this);
            button1Bac.setText("Bacterial Canker of Tomato2");
            Button button2Bac = new Button(this);
            button2Bac.setText("Bacterial Canker of Tomato3");
            Button[] arrayButtonFungal = {buttonBac, button1Bac, button2Bac};
            for(int btn = 0;btn <arrayButtonFungal.length;btn++) {
                Button buttons = arrayButtonFungal[btn];
                buttonLinear.addView(buttons,buttonLinear.getLayoutParams());
                buttons.setBackgroundResource(R.drawable.rounded);
            ...
            buttonBac.setOnClickListener(view -> {
                if (currentLanguage.equals("en")) {
                    htmlText = "<h2><font color=\\\"#2E7D32\\\"><b>Bacterial Canker of Tomato (Bacterial canker of tomato)</b></font></h2><br/>" +
                            "<h3>Causal Agent</h3>" +
                            "<p>Clavibacter michiganensis subsp. michiganensis (Cmm)" +
                            " Gram-positive bacterium belonging to the class Actinobacteria. The pathogen forms" +
                            " cell chains, produces exopolysaccharides, enzymes and toxins that" +
                            " destroy plant tissues, contributing to the development of necrosis and wilting. Cmm is able" +
                            " to penetrate the plant vascular system through wounds on roots, stems or after" +
                            " mechanical damage, which ensures systemic spread of the infection.</p><br/>" +
                            "<img src='bacterial_picture1'/><br/>" +

                            "<h3>Symptoms</h3>" +
                            "<p><b>Leaves:</b></p>" +
                            "<p>⦁ One-sided wilting of the upper leaves is often observed. In this case, one side of the leaf wilts, while the other retains turgor, which leads to curvature of the leaf blade<br/>" +
                            "⦁ Blister-like or bubble-like spots on leaves. This symptom appears during secondary infection in tomato nurseries.<br/>" +
                            "⦁ In case of local infection, general yellowing of leaves, especially older ones.</p>" +
                            "<div style = 'display:flex; justify-content: center;'>" +
                            ...
                            "<p><b>Stems and Petioles:</b></p>" +
                            "<p>⦁ <i>In systemic infection, gradual darkening of the vascular xylem tissues occurs. Cmm penetrates through natural openings or wounds, multiplies in the xylem and causes blockage of vessels, thereby leading to plant wilting. Initial signs of tomato plant wilting usually appear in the middle part of the plant and then spread upward and downward along the stem, causing wilting and plant death.</i><br/>" +
                            "⦁ <i>Formation of stem cankers with brown and hollow vascular bundles at late stages of infection.</i><br/>" +
                            ...
                            "<p><b>Fruits:</b></p>" +
                            "<p>⦁ Bird’s eye; necrotic spots 1–3 mm in diameter on the fruit epidermis. Spot color varies from white (on unripe tomato fruits) to dark brown (on ripe fruits).<br/>" +
                            "⦁ Infected fruits may have a net-like or marbled texture.</p>" +
                            ...
                            "<h3>Epidemiology and Life Cycle</h3>" +
                            "<p><b>Sources of Infection:</b><br/>" +
                            "⦁ Infected tomato seeds;<br/>" +
                            "⦁ diseased plants in greenhouses and open fields;<br/>" +
                            "⦁ mechanical damage and tools contaminated with the pathogen;<br/>" +

                            "<p><b>Development and Spread:</b><br/><br/>" +
                            "⦁ The bacterium penetrates through wounds or injuries, stomata and quickly spreads through the vascular system,<br/>" +
                            "⦁ in protected cultivation the pathogen can persist for many years, causing disease outbreaks in almost every production cycle,<br/>" +
                            "⦁ spreads mechanically, through irrigation, seeds and tools.</p>" +

                            "<h4><b>Climatic Conditions Favoring Development:</b></h4>" +
                            "<p>⦁ Optimal temperature: 10–25 °C (with most active development at 15–20 °C).<br/>" +
                            "⦁ Mechanical damage to plants and dense planting increase the risk of infection spread.<br/></p>" +

                            "<h4>Features of Epidemiology:</h4>" +
                            "<p>⦁ Optimal temperature: 20–26 °C,<br/>" +
                            "⦁ In greenhouses the disease can spread rapidly and affect all plants,<br/>" +
                            "⦁ in open fields development is focal, but under favorable conditions severe wilting and plant death are observed.</p>" +

                            "<h3>Control and Preventive Measures</h3>" +
                            "<h5>Agrotechnical Measures:</h5>" +
                            "<p>⦁ Use of certified, healthy seeds and seedlings,<br/>" +
                            "⦁ destruction of plant residues after harvest,<br/>" +
                            "⦁ crop rotation: return tomato to the same field no earlier than after 3–4 years,<br/>" +
                            "⦁ disinfection of tools and equipment,<br/>" +
                            "⦁ maintaining optimal microclimate: good ventilation, avoidance of dense planting.</p>" +

                            "<h3>Biological Methods:</h3>" +
                            "<p>Application of biofungicides such as Fitolavin (a biofungicide based on phytobacteriomycin, a natural antibiotic obtained from the actinomycete Streptomyces griseus) for prevention of bacterial diseases of tomato, including bacterial canker. Effectiveness against Cmm is limited and more often serves as a supportive measure in combination with agrotechnical practices.</p>" +

                            "<h4>Chemical Methods:</h4>" +
                            "<p>⦁ Use of copper-containing products (copper oxychloride, Bordeaux mixture) and biofungicides for preventive purposes.<br/>" +
                            "⦁ Antibacterial agents (streptomycin, kasugamycin, tetracycline) are used only under high infection risk and in accordance with current safety regulations.</p>" +

                            "<h4>Integrated Plant Protection:</h4>" +
                            "<p>⦁ Combination of agrotechnical, biological and chemical practices.<br/>" +
                            "⦁ Regular phytosanitary monitoring of plants.<br/>" +
                            "⦁ Timely localization and removal of infected plants to prevent spread.<br/>";
                }
                else if(currentLanguage.equals("ru")) {
            ...
            button1Bac.setOnClickListener(view -> {
                if(currentLanguage.equals("en")){
                    htmlText = "hello";
                }
                else {
            ...
            button2Bac.setOnClickListener(view -> {
                if(currentLanguage.equals("en")){
                    htmlText = "hello";
                }
                else {
